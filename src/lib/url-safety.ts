...
// Validates CMS-sourced URLs before they're used as an <img src>, a CSS
// background-image url(), or a link href. CMS text fields are admin-
// editable, plain strings with no server-side scheme restriction — an
// unsanitized javascript:/data:/vbscript: value would execute on render
// (background-image url()) or on click (<a href>).
// ══════════════════════════════════════════════════
