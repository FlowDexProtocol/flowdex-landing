                ...
                <StaggerItem key={post.id}>
                  ...
                  >
                    <CmsImage
                      ...
                      fallback={
                        <div className="flex h-[200px] w-full items-center justify-center bg-gradient-to-br from-primary/20 to-purple/20 text-xs font-semibold uppercase tracking-widest text-primary/40">
                          {post.category}
                        </div>
                      }
                    />
